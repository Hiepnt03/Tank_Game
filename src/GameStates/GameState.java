...
public abstract class GameState {
    ...
    // nếu logo là một tập hợp các hình ảnh kết hợp (ví dụ: "Cấp 12" là "Cấp", "1" và "2" kết hợp)
    // sau đó chúng ta sử dụng ArrayList để lưu trữ các hình ảnh thay vì một hình ảnh duy nhất
    ...
    public void drawLogo(Graphics2D g, ImageObserver io) {
        ...
        if (logoWidth == 0) {
            ...
            //chia tỷ lệ sao cho chiều cao cuối cùng là 150;
            double ratio = (double) oHeight / (double) STANDARD_LOGO_HEIGHT;
            logoWidth = (int) ((double) oWidth / ratio);

        }

        //nếu người chơi đang ở trạng thái InGame thì logo được vẽ ở y=0 để nhường chỗ cho vẽ cấp độ
